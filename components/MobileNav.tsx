      ...
      <Transition appear show={navShow} as={Fragment} unmount={false}>
        <Dialog as="div" onClose={onToggleNav} unmount={false}>
          ...
          <Transition.Child
            ...
            unmount={false}
          >
            <Dialog.Panel className="fixed left-0 top-0 z-70 h-full w-full bg-white from-cyan-950 to-blue-950 opacity-95 duration-300 dark:bg-gradient-to-r dark:opacity-[0.98]">
              <nav
                ref={navRef}
